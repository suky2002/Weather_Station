const char* ssid = "Ion's Galaxy S22 Ultra"; // aici se scrie numele SSID al routerului WiFi de acasa
const char* password = "suky123@"; // aici este parola pentru conectarea la router
...
String serverName = "http://192.168.228.71/database.php"; // aici se defineste serverul catre care trimitem datele; cheia este introdusa automat.
void setup(){lcd.init();                     
  lcd.backlight();
  Serial.begin(9600);
  while (! Serial);
